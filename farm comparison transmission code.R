...
library(intergraph)
library(xlsx)
setwd("C:/users/A/Documents/PhD/thesis/code/Results/awayzAway_May_11_2017")
inpute<-list.files("C:/users/A/Documents/PhD/thesis/code/Results/awayzAway_May_11_2017/", pattern = "day.*.csv")
inputv<-list.files("C:/users/A/Documents/PhD/thesis/code/Results/awayzAway_May_11_2017/", pattern = "vertices.csv") 
